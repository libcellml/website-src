...
class TestBrowseAPIDocumentation(unittest.TestCase):
  ...
  def test_browseAPIDocumentation(self):
    ...
    el = WebDriverWait(self.driver, timeout=3).until(lambda d: d.find_element(By.CSS_SELECTOR, ".v-field__append-inner"))
    el.click()
    # 10 | click | css=.v-list-item:nth-child(2) .v-list-item-title | 
    el = WebDriverWait(self.driver, timeout=3).until(lambda d: d.find_element(By.XPATH, ("//div[contains(@class, '') and contains(text(), 'v0.2.0')]")))
    #el = WebDriverWait(self.driver, timeout=3).until(lambda d: d.find_element(By.CSS_SELECTOR, ".v-list-item:nth-child(2)"))
    actions.move_to_element(el).perform()
    actions.click().perform()
    self.assertEqual(self.vars["base_url"] + "/documentation/v0.2.0/api/classlibcellml_1_1Parser", self.driver.current_url)
    #el.click()
    ...
    el = WebDriverWait(self.driver, timeout=3).until(lambda d: d.find_element(By.CSS_SELECTOR, "#classlibcellml_1_1Logger_1a610d4878881567899c6d47db5e625736 a"))
    actions.move_to_element(el).perform()
    actions.click().perform()
